...
- While dragging within the same section, the faint original block surface moves to the intended logical grid cell before mouseup. The drag overlay follows the pointer, while the background preview communicates the eventual drop location.
